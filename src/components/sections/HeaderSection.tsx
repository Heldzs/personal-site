      ...
      <Container className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center w-full relative z-10 md:pl-20 lg:pl-28 xl:pl-32 2xl:pl-8">
        ...
        <div className="flex flex-col gap-8 lg:pl-8">
          ...
          <FadeIn direction="up" delay={0.4} className="flex flex-wrap gap-4">
            <a
              href="#projects"
              className="group inline-flex items-center justify-center relative px-8 py-4 bg-zinc-900 dark:bg-zinc-50 text-zinc-50 dark:text-zinc-900 font-semibold rounded-full overflow-hidden transition-transform hover:scale-105 active:scale-95"
            >
            ...
            <a
              href="#contact"
              className="inline-flex items-center justify-center px-8 py-4 border-2 border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-50 font-semibold rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors active:scale-95"
            >
              Entrar em Contato
            </a>
          </FadeIn>
