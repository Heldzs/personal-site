...
export function ProjectCard({
  ...
  return (
    <div className="group flex flex-col bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-3xl overflow-hidden">
      <a
        href={project.liveUrl}
        className="relative aspect-video w-full overflow-hidden bg-zinc-100 dark:bg-zinc-950 block"
      >
        <div
