export const projectsData = [
  {
    ...
    description: "",
    fullDescription:
      "Este painel administrativo foi desenvolvido para resolver o problema de gestão fragmentada de e-commerces de médio porte. A plataforma integra APIs de pagamento, sistemas de logística e oferece um dashboard analítico completo utilizando gráficos interativos da biblioteca Recharts. O foco principal foi garantir a performance ao processar grandes volumes de dados e manter a usabilidade impecável em dispositivos móveis.",
  ...
  },
  {
    ...
    title: "Campus Link",
    description:
      "Uma plataforma acadêmica baseada em Inteligência Artificial (RAG) que responde dúvidas de alunos com base em documentos oficiais. O sistema conta com uma interface de chat moderna com visualizador de PDF integrado e um painel administrativo completo para gestão da base de conhecimento.",
